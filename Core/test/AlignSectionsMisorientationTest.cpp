...
TEST_CASE("Reconstruction::AlignSectionsMisorientation: Instantiation and Parameter Check", "[Reconstruction][AlignSectionsMisorientation]")
{
  ...
  args.insertOrAssign(AlignSectionsMisorientationFilter::k_CrystalStructuresArrayPath_Key, std::make_any<DataPath>(DataPath{}));

...
Parameters FeatureDataCSVWriterFilter::parameters() const
{
  ...
  params.insert(std::make_unique<FileSystemPathParameter>(k_FeatureDataFile_Key, "Output File", "", fs::path("FeatureData.csv"), FileSystemPathParameter::ExtensionsType{},

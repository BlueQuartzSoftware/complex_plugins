...
#include "Core/Filters/Algorithms/Silhouette.hpp"
...
Parameters SilhouetteFilter::parameters() const
{
  ...
  params.insertSeparator(Parameters::Separator{"Required Input Data Arrays"});
  ...
  params.insertSeparator(Parameters::Separator{"Created Data Arrays"});

...
#include "Core/Filters/Algorithms/KMeans.hpp"
...
namespace
{
ChoicesParameter::Choices k_ClusterChoices = {"Euclidean", "Squared Euclidean"};
}
...
Parameters KMeansFilter::parameters() const
{
  ...
  std::make_unique<ArraySelectionParameter>(k_MaskArrayPath_Key, "Mask", "", DataPath{}, complex::GetAllDataTypes());

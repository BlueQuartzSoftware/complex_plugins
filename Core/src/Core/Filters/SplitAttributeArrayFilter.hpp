 ...
 */
class CORE_EXPORT SplitAttributeArrayFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, SplitAttributeArrayFilter, "6dc586cc-59fb-4ee8-90ff-2d3587da12f5");

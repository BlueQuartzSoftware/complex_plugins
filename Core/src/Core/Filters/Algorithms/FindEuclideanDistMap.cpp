...
class ComputeDistanceMapImpl
{
  ...
  const FindEuclideanDistMapInputValues& m_InputValues;
  FindEuclideanDistMap::MapType m_MapType;

public:
  ComputeDistanceMapImpl(DataStructure& dataStructure, const FindEuclideanDistMapInputValues& inputValues, FindEuclideanDistMap::MapType mapType)
...
// -----------------------------------------------------------------------------
FindEuclideanDistMap::FindEuclideanDistMap(DataStructure& dataStructure, const IFilter::MessageHandler& mesgHandler, const std::atomic_bool& shouldCancel, FindEuclideanDistMapInputValues* inputValues)
: m_DataStructure(dataStructure)
, m_InputValues(inputValues)
...
// -----------------------------------------------------------------------------
template <typename T>
void findDistanceMap(DataStructure& dataStructure, const FindEuclideanDistMapInputValues* inputValues)
{
  using DataArrayType = DataArray<T>;

...
TEST_CASE("ITKInvertIntensityImageFilter(3d)", "[ITKImageProcessing][ITKInvertIntensityImage][3d]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKInvertIntensityImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
  ...
  // Write the output data to a file
  {
    ...
    ITKTestBase::RemoveFiles(testDir, "BasicFilters_InvertIntensityImageFilter_3d");
  } // End Scope Section
#if 0
  {

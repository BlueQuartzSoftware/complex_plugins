...
TEST_CASE("ITK::BinaryThresholdImageFilter(NarrowThreshold)", "[ITKImageProcessing][ITKBinaryThresholdImage][NarrowThreshold]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKBinaryThresholdImage::k_SelectedImageDataPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKBinaryThresholdImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    args.insertOrAssign(ITKBinaryThresholdImage::k_LowerThreshold_Key, std::make_any<float64>(10));
    args.insertOrAssign(ITKBinaryThresholdImage::k_UpperThreshold_Key, std::make_any<float64>(100));

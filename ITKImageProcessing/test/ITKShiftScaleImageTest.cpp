...
TEST_CASE("ITK::ShiftScaleImageFilter(params)","[ITKImageProcessing][ITKShiftScaleImage][params]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKShiftScaleImage::k_SelectedImageDataPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKShiftScaleImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    args.insertOrAssign(ITKShiftScaleImage::k_Shift_Key, std::make_any<double>(100));
    args.insertOrAssign(ITKShiftScaleImage::k_Scale_Key, std::make_any<double>(0.5));
    // Preflight the filter and check result
    auto preflightResult = filter.preflight(ds, args);
    COMPLEX_RESULT_REQUIRE_VALID(preflightResult.outputActions);
    // Execute the filter and check the result
...
TEST_CASE("ITK::ShiftScaleImageFilter(OutputPixel)","[ITKImageProcessing][ITKShiftScaleImage][OutputPixel]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKShiftScaleImage::k_SelectedImageDataPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKShiftScaleImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    args.insertOrAssign(ITKShiftScaleImage::k_Shift_Key, std::make_any<double>(32769));
    args.insertOrAssign(ITKShiftScaleImage::k_Scale_Key, std::make_any<double>(0.00389099121));
...
TEST_CASE("ITK::ShiftScaleImageFilter(OutputOverflow)","[ITKImageProcessing][ITKShiftScaleImage][OutputOverflow]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKShiftScaleImage::k_SelectedImageDataPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKShiftScaleImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    args.insertOrAssign(ITKShiftScaleImage::k_Shift_Key, std::make_any<double>(-1000));
    args.insertOrAssign(ITKShiftScaleImage::k_Scale_Key, std::make_any<double>(2));

...
TEST_CASE("ITKHConvexImageFilter(HConvex)", "[ITKImageProcessing][ITKHConvexImage][HConvex]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKHConvexImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    args.insertOrAssign(ITKHConvexImage::k_Height_Key, std::make_any<float64>(10000));
  ...
  // Write the output data to a file
  {
    ...
    ITKTestBase::RemoveFiles(testDir, "BasicFilters_HConvexImageFilter_HConvex");
  } // End Scope Section
#if 0
  {

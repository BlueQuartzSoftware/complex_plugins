...
TEST_CASE("ITKGrayscaleErodeImageFilter(GrayscaleErode)", "[ITKImageProcessing][ITKGrayscaleErodeImage][GrayscaleErode]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKGrayscaleErodeImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    auto pKernelRadius = std::vector<uint32_t>(3, 1);
    args.insertOrAssign(ITKGrayscaleErodeImage::k_KernelRadius_Key, std::make_any<VectorUInt32Parameter::ValueType>(pKernelRadius));
  ...
  // Write the output data to a file
  {
    ...
    ITKTestBase::RemoveFiles(testDir, "BasicFilters_GrayscaleErodeImageFilter_GrayscaleErode");
  } // End Scope Section
#if 0
  {

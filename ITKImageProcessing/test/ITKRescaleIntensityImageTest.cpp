...
TEST_CASE("ITKRescaleIntensityImageFilter(3d)", "[ITKImageProcessing][ITKRescaleIntensityImage][3d]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKRescaleIntensityImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
  ...
  // Write the output data to a file
  {
    ...
    ITKTestBase::RemoveFiles(testDir, "BasicFilters_RescaleIntensityImageFilter_3d");
  } // End Scope Section
#if 0
  {

...
TEST_CASE("ITK::BinaryContourImageFilter(default)","[ITKImageProcessing][ITKBinaryContourImage][default]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKBinaryContourImage::k_ForegroundValue_Key, std::make_any<double>(255.0));
...
TEST_CASE("ITK::BinaryContourImageFilter(custom)","[ITKImageProcessing][ITKBinaryContourImage][custom]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKBinaryContourImage::k_SelectedImageDataPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKBinaryContourImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    args.insertOrAssign(ITKBinaryContourImage::k_ForegroundValue_Key, std::make_any<double>(100));

...
TEST_CASE("ITK::CurvatureFlowImageFilter(defaults)","[ITKImageProcessing][ITKCurvatureFlowImage][defaults]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKCurvatureFlowImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
...
TEST_CASE("ITK::CurvatureFlowImageFilter(longer)","[ITKImageProcessing][ITKCurvatureFlowImage][longer]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  ITKCurvatureFlowImage filter;
  DataStructure ds;
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKCurvatureFlowImage::k_SelectedImageDataPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKCurvatureFlowImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    args.insertOrAssign(ITKCurvatureFlowImage::k_TimeStep_Key, std::make_any<double>(0.1));

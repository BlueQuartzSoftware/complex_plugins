...
TEST_CASE("ITK::MorphologicalWatershedImageFilter(defaults)","[ITKImageProcessing][ITKMorphologicalWatershedImage][defaults]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKMorphologicalWatershedImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
...
// Set some parameters
TEST_CASE("ITK::MorphologicalWatershedImageFilter(level_1)","[ITKImageProcessing][ITKMorphologicalWatershedImage][level_1]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  ITKMorphologicalWatershedImage filter;
  DataStructure ds;
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKMorphologicalWatershedImage::k_SelectedImageDataPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKMorphologicalWatershedImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
    args.insertOrAssign(ITKMorphologicalWatershedImage::k_Level_Key, std::make_any<double>(1.0));

...
TEST_CASE("ITK::GrayscaleMorphologicalOpeningImageFilter(GrayscaleMorphologicalOpeningVectorRadius1)","[ITKImageProcessing][ITKGrayscaleMorphologicalOpeningImage][GrayscaleMorphologicalOpeningVectorRadius1]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  ITKGrayscaleMorphologicalOpeningImage filter;
  DataStructure ds;
...
TEST_CASE("ITK::GrayscaleMorphologicalOpeningImageFilter(GrayscaleMorphologicalOpeningVectorRadius2)","[ITKImageProcessing][ITKGrayscaleMorphologicalOpeningImage][GrayscaleMorphologicalOpeningVectorRadius2]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  ITKGrayscaleMorphologicalOpeningImage filter;
  DataStructure ds;

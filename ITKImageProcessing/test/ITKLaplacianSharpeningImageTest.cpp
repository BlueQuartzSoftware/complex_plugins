...
TEST_CASE("ITKLaplacianSharpeningImageFilter(default)", "[ITKImageProcessing][ITKLaplacianSharpeningImage][default]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKLaplacianSharpeningImage::k_OutputIamgeDataPath_Key, std::make_any<DataPath>(outputDataPath));
  ...
  // Write the output data to a file
  {
    ...
    ITKTestBase::RemoveFiles(testDir, "BasicFilters_LaplacianSharpeningImageFilter_default");
  } // End Scope Section
#if 0
  {
...
TEST_CASE("ITKLaplacianSharpeningImageFilter(shortdefault)", "[ITKImageProcessing][ITKLaplacianSharpeningImage][shortdefault]")
{
  ...
  // Write the output data to a file
  {
    ...
    // Remove *all* files generated by this test
    fs::path testDir = fs::path(unit_test::k_BinaryDir.view()) / "test";
    ITKTestBase::RemoveFiles(testDir, "BasicFilters_LaplacianSharpeningImageFilter_shortdefault");
  } // End Scope Section
#if 0
  {
...
TEST_CASE("ITKLaplacianSharpeningImageFilter(vectordefault)", "[ITKImageProcessing][ITKLaplacianSharpeningImage][vectordefault]")
{
  ...
  // Write the output data to a file
  {
    ...
    // Remove *all* files generated by this test
    fs::path testDir = fs::path(unit_test::k_BinaryDir.view()) / "test";
    ITKTestBase::RemoveFiles(testDir, "BasicFilters_LaplacianSharpeningImageFilter_vectordefault");
  } // End Scope Section
#if 0
  {

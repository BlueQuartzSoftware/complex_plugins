...
public:
  ...
  static inline constexpr StringLiteral k_ImportAllMetaData_Key = "import_all_meta_data";
  ...
  static inline constexpr StringLiteral k_MetaDataAttributeMatrixName_Key = "meta_data_attribute_matrix_name";

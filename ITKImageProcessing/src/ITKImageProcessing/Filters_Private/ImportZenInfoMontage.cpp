...
Parameters ImportZenInfoMontage::parameters() const
{
  ...
  params.insert(std::make_unique<FileSystemPathParameter>(k_InputFile_Key, "Zen Export File (*_info.xml)", "", fs::path("<default file to read goes here>"), FileSystemPathParameter::ExtensionsType{},
...
//------------------------------------------------------------------------------
IFilter::PreflightResult ImportZenInfoMontage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler,
...
//------------------------------------------------------------------------------
Result<> ImportZenInfoMontage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler,
                                           const std::atomic_bool& shouldCancel) const
{
  /****************************************************************************

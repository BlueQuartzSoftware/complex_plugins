 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKMorphologicalGradientImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKMorphologicalGradientImage, "bf889097-f4ad-47f1-b297-432fb818cf15");

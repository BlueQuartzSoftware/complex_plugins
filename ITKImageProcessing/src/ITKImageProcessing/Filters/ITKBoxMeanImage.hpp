...
{
public:
  ITKBoxMeanImage() = default;
  ~ITKBoxMeanImage() noexcept override = default;

  ITKBoxMeanImage(const ITKBoxMeanImage&) = delete;
  ITKBoxMeanImage(ITKBoxMeanImage&&) noexcept = delete;

  ITKBoxMeanImage& operator=(const ITKBoxMeanImage&) = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKBoxMeanImage, "6138f949-e363-5ca3-bc31-4f3daed65da5");

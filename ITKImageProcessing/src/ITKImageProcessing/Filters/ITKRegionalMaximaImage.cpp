...
#define ITK_ARRAY_HELPER_NAMESPACE RegionalMaximaImage
...
struct ITKRegionalMaximaImageCreationFunctor
{
  ...
  auto operator()() const
  {
    ...
    filter->SetFlatIsMaxima(pFlatIsMaxima);
    return filter;
  }
};
} // namespace
...
//------------------------------------------------------------------------------
IFilter::PreflightResult ITKRegionalMaximaImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  /****************************************************************************
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = RegionalMaximaImage::ITK::DataCheck<FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
//------------------------------------------------------------------------------
Result<> ITKRegionalMaximaImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
  /****************************************************************************
   ...
   ***************************************************************************/
  ::ITKRegionalMaximaImageCreationFunctor itkFunctor = {pBackgroundValue, pForegroundValue, pFullyConnected, pFlatIsMaxima};
   ...
   ***************************************************************************/
  return RegionalMaximaImage::ITK::Execute<ITKRegionalMaximaImageCreationFunctor, FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

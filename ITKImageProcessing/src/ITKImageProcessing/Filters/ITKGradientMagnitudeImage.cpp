...
#define ITK_ARRAY_HELPER_NAMESPACE GradientMagnitudeImage
...
struct ITKGradientMagnitudeImageCreationFunctor
{
...
IFilter::PreflightResult ITKGradientMagnitudeImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = GradientMagnitudeImage::ITK::DataCheck<FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKGradientMagnitudeImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKGradientMagnitudeImageCreationFunctor itkFunctor = {pUseImageSpacing};
   ...
   ***************************************************************************/
  return GradientMagnitudeImage::ITK::Execute<ITKGradientMagnitudeImageCreationFunctor, FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

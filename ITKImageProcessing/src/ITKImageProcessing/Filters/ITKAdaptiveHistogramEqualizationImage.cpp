                                                            ...
                                                            const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKAdaptiveHistogramEqualizationImage::ArrayOptionsT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor, messageHandler);
}
} // namespace complex

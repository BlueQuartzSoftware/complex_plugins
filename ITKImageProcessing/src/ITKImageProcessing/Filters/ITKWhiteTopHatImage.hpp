 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKWhiteTopHatImage : public IFilter
{
public:
  ITKWhiteTopHatImage() = default;
  ~ITKWhiteTopHatImage() noexcept override = default;

  ITKWhiteTopHatImage(const ITKWhiteTopHatImage&) = delete;
  ITKWhiteTopHatImage(ITKWhiteTopHatImage&&) noexcept = delete;

  ITKWhiteTopHatImage& operator=(const ITKWhiteTopHatImage&) = delete;
  ITKWhiteTopHatImage& operator=(ITKWhiteTopHatImage&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKWhiteTopHatImage, "02e059f7-8055-52b4-9d48-915b67d1e39a");

...
{
public:
  ITKGrayscaleMorphologicalOpeningImage() = default;
  ~ITKGrayscaleMorphologicalOpeningImage() noexcept override = default;

  ITKGrayscaleMorphologicalOpeningImage(const ITKGrayscaleMorphologicalOpeningImage&) = delete;
  ITKGrayscaleMorphologicalOpeningImage(ITKGrayscaleMorphologicalOpeningImage&&) noexcept = delete;

  ITKGrayscaleMorphologicalOpeningImage& operator=(const ITKGrayscaleMorphologicalOpeningImage&) = delete;
  ITKGrayscaleMorphologicalOpeningImage& operator=(ITKGrayscaleMorphologicalOpeningImage&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKGrayscaleMorphologicalOpeningImage, "c88ac42b-9477-5088-9ec0-862af1e0bb56");

...
public:
  ITKTanImage() = default;
  ~ITKTanImage() noexcept override = default;

  ITKTanImage(const ITKTanImage&) = delete;
  ITKTanImage(ITKTanImage&&) noexcept = delete;

  ITKTanImage& operator=(const ITKTanImage&) = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKTanImage, "672810d9-5ec0-59c1-a209-8fb56c7a018a");

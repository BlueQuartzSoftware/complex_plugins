...
#define ITK_ARRAY_HELPER_NAMESPACE GrayscaleDilateImage
...
namespace
{
struct ITKGrayscaleDilateImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::GrayscaleDilateImageFilter<InputImageType, OutputImageType, itk::FlatStructuringElement<InputImageType::ImageDimension>>;
...
IFilter::PreflightResult ITKGrayscaleDilateImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = GrayscaleDilateImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKGrayscaleDilateImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKGrayscaleDilateImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType};
   ...
   ***************************************************************************/
  return GrayscaleDilateImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

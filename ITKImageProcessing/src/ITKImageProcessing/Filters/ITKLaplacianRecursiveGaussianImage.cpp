...
#define ITK_ARRAY_HELPER_NAMESPACE LaplacianRecursiveGaussianImage
...
struct ITKLaplacianRecursiveGaussianImageCreationFunctor
{
  float64 pSigma = 1.0;
...
IFilter::PreflightResult ITKLaplacianRecursiveGaussianImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = LaplacianRecursiveGaussianImage::ITK::DataCheck<FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKLaplacianRecursiveGaussianImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKLaplacianRecursiveGaussianImageCreationFunctor itkFunctor = {pSigma, pNormalizeAcrossScale};
   ...
   ***************************************************************************/
  return LaplacianRecursiveGaussianImage::ITK::Execute<ITKLaplacianRecursiveGaussianImageCreationFunctor, FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath,
                                                                                                                            itkFunctor);
}
} // namespace complex

...
struct ITKBilateralImageCreationFunctor
{
  double pDomainSigma;
  double pRangeSigma;
  unsigned int pNumberOfRangeGaussianSamples;
...
{
  return {"ITKImageProcessing", "ITKBilateralImage"};
}
...
IFilter::PreflightResult ITKBilateralImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  auto pDomainSigma = filterArgs.value<double>(k_DomainSigma_Key);
  auto pRangeSigma = filterArgs.value<double>(k_RangeSigma_Key);
...
Result<> ITKBilateralImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKBilateralImageCreationFunctor itkFunctor{};
  itkFunctor.pDomainSigma = pDomainSigma;
  itkFunctor.pRangeSigma = pRangeSigma;
  itkFunctor.pNumberOfRangeGaussianSamples = pNumberOfRangeGaussianSamples;

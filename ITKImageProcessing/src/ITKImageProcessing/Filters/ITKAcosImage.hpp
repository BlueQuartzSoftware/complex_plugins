...
{
public:
  ITKAcosImage() = default;
  ~ITKAcosImage() noexcept override = default;

  ITKAcosImage(const ITKAcosImage&) = delete;
  ITKAcosImage(ITKAcosImage&&) noexcept = delete;

  ITKAcosImage& operator=(const ITKAcosImage&) = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKAcosImage, "b09ec654-87a5-5dfa-9949-aa69f1fbfdd1");

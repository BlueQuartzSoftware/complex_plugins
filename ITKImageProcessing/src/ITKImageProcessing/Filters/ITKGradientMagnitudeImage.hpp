...
{
public:
  ITKGradientMagnitudeImage() = default;
  ~ITKGradientMagnitudeImage() noexcept override = default;

  ITKGradientMagnitudeImage(const ITKGradientMagnitudeImage&) = delete;
  ITKGradientMagnitudeImage(ITKGradientMagnitudeImage&&) noexcept = delete;

  ITKGradientMagnitudeImage& operator=(const ITKGradientMagnitudeImage&) = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKGradientMagnitudeImage, "3aa99151-e722-51a0-90ba-71e93347ab09");

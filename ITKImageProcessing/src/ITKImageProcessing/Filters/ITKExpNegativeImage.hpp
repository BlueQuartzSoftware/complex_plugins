...
{
public:
  ITKExpNegativeImage() = default;
  ~ITKExpNegativeImage() noexcept override = default;

  ITKExpNegativeImage(const ITKExpNegativeImage&) = delete;
  ITKExpNegativeImage(ITKExpNegativeImage&&) noexcept = delete;

  ITKExpNegativeImage& operator=(const ITKExpNegativeImage&) = delete;
  ITKExpNegativeImage& operator=(ITKExpNegativeImage&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKExpNegativeImage, "634c2306-c1ee-5a45-a55c-f8286e36999a");

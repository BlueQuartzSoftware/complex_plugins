...
#define ITK_ARRAY_HELPER_NAMESPACE ThresholdMaximumConnectedComponentsImage
...
{
  uint32_t pMinimumObjectSizeInPixels = 0u;
  float64 pUpperBoundary = std::numeric_limits<double>::max();
...
IFilter::PreflightResult ITKThresholdMaximumConnectedComponentsImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = ThresholdMaximumConnectedComponentsImage::ITK::DataCheck<FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
                                                                  ...
                                                                  const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKThresholdMaximumConnectedComponentsImageCreationFunctor itkFunctor = {pMinimumObjectSizeInPixels, pUpperBoundary, pInsideValue, pOutsideValue};
   ...
   ***************************************************************************/
  return ThresholdMaximumConnectedComponentsImage::ITK::Execute<ITKThresholdMaximumConnectedComponentsImageCreationFunctor, FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath,

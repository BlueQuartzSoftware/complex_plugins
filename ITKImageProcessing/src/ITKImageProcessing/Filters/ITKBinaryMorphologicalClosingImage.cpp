...
#define ITK_ARRAY_HELPER_NAMESPACE BinaryMorphologicalClosingImage
...
namespace
{
struct ITKBinaryMorphologicalClosingImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::BinaryMorphologicalClosingImageFilter<InputImageType, OutputImageType, itk::FlatStructuringElement<InputImageType::ImageDimension>>;
...
//------------------------------------------------------------------------------
IFilter::PreflightResult ITKBinaryMorphologicalClosingImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  /****************************************************************************
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = BinaryMorphologicalClosingImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
//------------------------------------------------------------------------------
Result<> ITKBinaryMorphologicalClosingImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
  /****************************************************************************
   ...
   ***************************************************************************/
  ::ITKBinaryMorphologicalClosingImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType, pForegroundValue, pSafeBorder};
   ...
   ***************************************************************************/
  return BinaryMorphologicalClosingImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

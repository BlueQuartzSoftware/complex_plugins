...
#define ITK_ARRAY_HELPER_NAMESPACE InvertIntensityImage
...
namespace
{
struct ITKInvertIntensityImageCreationFunctor
{
  double pMaximum = 255;
...
IFilter::PreflightResult ITKInvertIntensityImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  auto pMaximum = filterArgs.value<float64>(k_Maximum_Key);
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = InvertIntensityImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKInvertIntensityImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKInvertIntensityImageCreationFunctor itkFunctor = {pMaximum};
   ...
   ***************************************************************************/
  return InvertIntensityImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

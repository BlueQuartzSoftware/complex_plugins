...
#define ITK_ARRAY_HELPER_NAMESPACE BinaryOpeningByReconstructionImage
...
namespace
{
struct ITKBinaryOpeningByReconstructionImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::BinaryOpeningByReconstructionImageFilter<InputImageType, itk::FlatStructuringElement<InputImageType::ImageDimension>>;
...
IFilter::PreflightResult ITKBinaryOpeningByReconstructionImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = BinaryOpeningByReconstructionImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKBinaryOpeningByReconstructionImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKBinaryOpeningByReconstructionImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType, pForegroundValue, pBackgroundValue, pFullyConnected};
   ...
   ***************************************************************************/
  return BinaryOpeningByReconstructionImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

...
#define ITK_ARRAY_HELPER_NAMESPACE MorphologicalGradientImage
...
namespace
{
struct ITKMorphologicalGradientImageCreationFunctor
{
...
IFilter::PreflightResult ITKMorphologicalGradientImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = MorphologicalGradientImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKMorphologicalGradientImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKMorphologicalGradientImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType};
   ...
   ***************************************************************************/
  return MorphologicalGradientImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

...
{
/**
 * @class ITKMinimumProjectionImage
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKMinimumProjectionImage : public IFilter
{
public:
  ITKMinimumProjectionImage() = default;
  ~ITKMinimumProjectionImage() noexcept override = default;

  ITKMinimumProjectionImage(const ITKMinimumProjectionImage&) = delete;
  ITKMinimumProjectionImage(ITKMinimumProjectionImage&&) noexcept = delete;

  ITKMinimumProjectionImage& operator=(const ITKMinimumProjectionImage&) = delete;
  ITKMinimumProjectionImage& operator=(ITKMinimumProjectionImage&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKMinimumProjectionImage, "6394a737-4a31-5593-9bb5-28492129ccf7");

...
#define ITK_ARRAY_HELPER_NAMESPACE GrayscaleFillholeImage
...
namespace
{
struct ITKGrayscaleFillholeImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::GrayscaleFillholeImageFilter<InputImageType, OutputImageType>;
...
IFilter::PreflightResult ITKGrayscaleFillholeImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = GrayscaleFillholeImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKGrayscaleFillholeImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKGrayscaleFillholeImageCreationFunctor itkFunctor = {pFullyConnected};
   ...
   ***************************************************************************/
  return GrayscaleFillholeImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

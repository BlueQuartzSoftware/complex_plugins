...
#define ITK_ARRAY_HELPER_NAMESPACE GrayscaleGrindPeakImage
...
namespace
{
struct ITKGrayscaleGrindPeakImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::GrayscaleGrindPeakImageFilter<InputImageType, OutputImageType>;
...
IFilter::PreflightResult ITKGrayscaleGrindPeakImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = GrayscaleGrindPeakImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKGrayscaleGrindPeakImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKGrayscaleGrindPeakImageCreationFunctor itkFunctor = {pFullyConnected};
   ...
   ***************************************************************************/
  return GrayscaleGrindPeakImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

...
#define ITK_ARRAY_HELPER_NAMESPACE SquareImage
...
namespace
{
struct ITKSquareImageCreationFunctor
{
...
{
  return FilterTraits<ITKSquareImage>::name.str();
}
...
IFilter::PreflightResult ITKSquareImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = SquareImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKSquareImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKSquareImageCreationFunctor itkFunctor = {};
   ...
   ***************************************************************************/
  return SquareImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

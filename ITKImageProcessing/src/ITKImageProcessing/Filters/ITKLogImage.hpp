...
public:
  ITKLogImage() = default;
  ~ITKLogImage() noexcept override = default;

  ITKLogImage(const ITKLogImage&) = delete;
  ITKLogImage(ITKLogImage&&) noexcept = delete;

  ITKLogImage& operator=(const ITKLogImage&) = delete;
  ITKLogImage& operator=(ITKLogImage&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKLogImage, "69aba77c-9a35-5251-a18a-e3728ddd2963");

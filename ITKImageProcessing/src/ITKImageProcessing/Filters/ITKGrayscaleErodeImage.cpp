...
#define ITK_ARRAY_HELPER_NAMESPACE GrayscaleErodeImage
...
namespace
{
struct ITKGrayscaleErodeImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::GrayscaleErodeImageFilter<InputImageType, OutputImageType, itk::FlatStructuringElement<InputImageType::ImageDimension>>;
...
IFilter::PreflightResult ITKGrayscaleErodeImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = GrayscaleErodeImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKGrayscaleErodeImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKGrayscaleErodeImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType};
   ...
   ***************************************************************************/
  return GrayscaleErodeImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

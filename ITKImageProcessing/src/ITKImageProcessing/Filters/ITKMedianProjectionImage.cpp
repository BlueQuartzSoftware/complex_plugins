...
#define ITK_ARRAY_HELPER_NAMESPACE MedianProjectionImage
...
namespace
{
struct ITKMedianProjectionImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::MedianProjectionImageFilter<InputImageType, OutputImageType>;
...
{
  return FilterTraits<ITKMedianProjectionImage>::name.str();
}
...
IFilter::PreflightResult ITKMedianProjectionImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = MedianProjectionImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKMedianProjectionImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKMedianProjectionImageCreationFunctor itkFunctor = {pProjectionDimension};

  /****************************************************************************
   * Write your algorithm implementation in this function
   ***************************************************************************/
  return MedianProjectionImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

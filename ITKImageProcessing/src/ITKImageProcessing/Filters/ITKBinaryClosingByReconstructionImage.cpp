...
#define ITK_ARRAY_HELPER_NAMESPACE BinaryClosingByReconstructionImage
...
namespace
{
struct ITKBinaryClosingByReconstructionImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::BinaryClosingByReconstructionImageFilter<InputImageType, itk::FlatStructuringElement<InputImageType::ImageDimension>>;
...
IFilter::PreflightResult ITKBinaryClosingByReconstructionImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = BinaryClosingByReconstructionImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKBinaryClosingByReconstructionImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKBinaryClosingByReconstructionImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType, pForegroundValue, pFullyConnected};
   ...
   ***************************************************************************/
  return BinaryClosingByReconstructionImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

...
#define ITK_ARRAY_HELPER_NAMESPACE SaltAndPepperNoiseImage
...
IFilter::PreflightResult ITKSaltAndPepperNoiseImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = SaltAndPepperNoiseImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKSaltAndPepperNoiseImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKSaltAndPepperNoiseImageCreationFunctor itkFunctor = {pProbability, pSeed};
   ...
   ***************************************************************************/
  return SaltAndPepperNoiseImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

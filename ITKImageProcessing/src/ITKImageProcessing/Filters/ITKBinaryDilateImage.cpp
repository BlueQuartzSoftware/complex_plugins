...
#define ITK_ARRAY_HELPER_NAMESPACE BinaryDilateImage
...
namespace
{
struct ITKBinaryDilateImageCreationFunctor
{
  ...
  bool pBoundaryToForeground = false;

  template <class InputImageType, class OutputImageType, uint32 Dimension>
  auto operator()() const
  {
    using FilterType = itk::BinaryDilateImageFilter<InputImageType, OutputImageType, itk::FlatStructuringElement<InputImageType::ImageDimension>>;
...
IFilter::PreflightResult ITKBinaryDilateImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = BinaryDilateImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKBinaryDilateImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKBinaryDilateImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType, pBackgroundValue, pForegroundValue, pBoundaryToForeground};
   ...
   ***************************************************************************/
  return BinaryDilateImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

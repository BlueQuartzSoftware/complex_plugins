...
{
public:
  ITKLog10Image() = default;
  ~ITKLog10Image() noexcept override = default;

  ITKLog10Image(const ITKLog10Image&) = delete;
  ITKLog10Image(ITKLog10Image&&) noexcept = delete;

  ITKLog10Image& operator=(const ITKLog10Image&) = delete;
  ITKLog10Image& operator=(ITKLog10Image&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKLog10Image, "900ca377-e79d-4b54-b298-33d518238099");

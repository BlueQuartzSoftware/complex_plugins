...
{
public:
  ITKGrayscaleMorphologicalClosingImage() = default;
  ~ITKGrayscaleMorphologicalClosingImage() noexcept override = default;

  ITKGrayscaleMorphologicalClosingImage(const ITKGrayscaleMorphologicalClosingImage&) = delete;
  ITKGrayscaleMorphologicalClosingImage(ITKGrayscaleMorphologicalClosingImage&&) noexcept = delete;

  ITKGrayscaleMorphologicalClosingImage& operator=(const ITKGrayscaleMorphologicalClosingImage&) = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKGrayscaleMorphologicalClosingImage, "849a1903-5595-5029-bbde-6f4b68b2a25c");

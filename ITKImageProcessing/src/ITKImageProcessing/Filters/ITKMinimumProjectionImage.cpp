...
#define ITK_ARRAY_HELPER_NAMESPACE MinimumProjectionImage
...
namespace
{
struct ITKMinimumProjectionImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::MinimumProjectionImageFilter<InputImageType, OutputImageType>;
...
IFilter::PreflightResult ITKMinimumProjectionImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = MinimumProjectionImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKMinimumProjectionImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKMinimumProjectionImageCreationFunctor itkFunctor = {pProjectionDimension};

  /****************************************************************************
   * Write your algorithm implementation in this function
   ***************************************************************************/
  return MinimumProjectionImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

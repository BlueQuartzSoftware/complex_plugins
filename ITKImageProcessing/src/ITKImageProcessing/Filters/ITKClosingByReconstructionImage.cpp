                                                      ...
                                                      const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKClosingByReconstructionImage::ArrayOptionsT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor, messageHandler);
}
} // namespace complex

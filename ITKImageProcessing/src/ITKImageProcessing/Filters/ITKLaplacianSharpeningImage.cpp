...
#define ITK_ARRAY_HELPER_NAMESPACE LaplacianSharpeningImage
...
namespace
{
struct ITKLaplacianSharpeningImageCreationFunctor
{
...
IFilter::PreflightResult ITKLaplacianSharpeningImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = LaplacianSharpeningImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKLaplacianSharpeningImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKLaplacianSharpeningImageCreationFunctor itkFunctor = {pUseImageSpacing};
   ...
   ***************************************************************************/
  return LaplacianSharpeningImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

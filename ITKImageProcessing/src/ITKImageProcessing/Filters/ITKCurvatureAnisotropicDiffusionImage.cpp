...
#define ITK_ARRAY_HELPER_NAMESPACE CurvatureAnisotropicDiffusionImage
...
namespace
{
struct ITKCurvatureAnisotropicDiffusionImageCreationFunctor
{
  float64 pTimeStep = 0.0625;
  float64 pConductanceParameter = 3;
...
//------------------------------------------------------------------------------
IFilter::PreflightResult ITKCurvatureAnisotropicDiffusionImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  /****************************************************************************
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = CurvatureAnisotropicDiffusionImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
//------------------------------------------------------------------------------
Result<> ITKCurvatureAnisotropicDiffusionImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
  /****************************************************************************
   ...
   ***************************************************************************/
  ::ITKCurvatureAnisotropicDiffusionImageCreationFunctor itkFunctor = {pTimeStep, pConductanceParameter, pConductanceScalingUpdateInterval, pNumberOfIterations};
   ...
   ***************************************************************************/
  return CurvatureAnisotropicDiffusionImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

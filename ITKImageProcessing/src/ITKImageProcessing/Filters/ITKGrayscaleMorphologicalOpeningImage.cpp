...
#define ITK_ARRAY_HELPER_NAMESPACE GrayscaleMorphologicalOpeningImage
...
namespace
{
struct ITKGrayscaleMorphologicalOpeningImageCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::GrayscaleMorphologicalOpeningImageFilter<InputImageType, OutputImageType, itk::FlatStructuringElement<InputImageType::ImageDimension>>;
...
IFilter::PreflightResult ITKGrayscaleMorphologicalOpeningImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = GrayscaleMorphologicalOpeningImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKGrayscaleMorphologicalOpeningImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKGrayscaleMorphologicalOpeningImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType, pSafeBorder};
   ...
   ***************************************************************************/
  return GrayscaleMorphologicalOpeningImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

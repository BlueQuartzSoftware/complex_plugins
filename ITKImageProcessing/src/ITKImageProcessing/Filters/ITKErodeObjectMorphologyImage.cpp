...
#define ITK_ARRAY_HELPER_NAMESPACE ErodeObjectMorphologyImage
...
IFilter::PreflightResult ITKErodeObjectMorphologyImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = ErodeObjectMorphologyImage::ITK::DataCheck(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKErodeObjectMorphologyImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKErodeObjectMorphologyImageCreationFunctor itkFunctor = {pKernelRadius, pKernelType, pObjectValue, pBackgroundValue};
   ...
   ***************************************************************************/
  return ErodeObjectMorphologyImage::ITK::Execute(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

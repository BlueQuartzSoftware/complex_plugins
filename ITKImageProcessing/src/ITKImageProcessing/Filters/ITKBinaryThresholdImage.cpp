...
#define ITK_ARRAY_HELPER_NAMESPACE BinaryThresholdImage
...
struct ITKBinaryThresholdImageCreationFunctor
{
  ...
  auto operator()() const
  {
    ...
    filter->SetLowerThreshold(pLowerThreshold);
    filter->SetUpperThreshold(pUpperThreshold);
...
IFilter::PreflightResult ITKBinaryThresholdImage::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler) const
{
  ...
  // store those actions.
  complex::Result<OutputActions> resultOutputActions = BinaryThresholdImage::ITK::DataCheck<FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath);
...
Result<> ITKBinaryThresholdImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  return BinaryThresholdImage::ITK::Execute<ITKBinaryThresholdImageCreationFunctor, FilterOutputType>(dataStructure, pSelectedInputArray, pImageGeomPath, pOutputArrayPath, itkFunctor);
}
} // namespace complex

...
{
public:
  ITKSqrtImage() = default;
  ~ITKSqrtImage() noexcept override = default;

  ITKSqrtImage(const ITKSqrtImage&) = delete;
  ITKSqrtImage(ITKSqrtImage&&) noexcept = delete;

  ITKSqrtImage& operator=(const ITKSqrtImage&) = delete;
  ITKSqrtImage& operator=(ITKSqrtImage&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKSqrtImage, "8087dcad-68f2-598b-9670-d0f57647a445");

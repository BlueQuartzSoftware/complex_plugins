...
{
/**
 * @class INLWriterFilter
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT INLWriterFilter : public IFilter
{
public:
  INLWriterFilter() = default;
  ~INLWriterFilter() noexcept override = default;

  INLWriterFilter(const INLWriterFilter&) = delete;
  INLWriterFilter(INLWriterFilter&&) noexcept = delete;

  INLWriterFilter& operator=(const INLWriterFilter&) = delete;
  INLWriterFilter& operator=(INLWriterFilter&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, INLWriterFilter, "a5a37eb3-c143-4b38-a89b-e0641a20dc7e");

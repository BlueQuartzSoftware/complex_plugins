...
// #include "OrientationAnalysis/Filters/GenerateFaceIPFColoring.hpp"
...
namespace complex
{
  static const std::map<complex::Uuid, complex::Uuid> k_SIMPL_to_OrientationAnalysis
  {
    ...
    {complex::Uuid::FromString("85900eba-3da9-5985-ac71-1d9d290a5d31").value(), complex::FilterTraits<VisualizeGBCDPoleFigureFilter>::uuid}, // VisualizeGBCDPoleFigureFilter
    ...
    {complex::Uuid::FromString("433976f0-710a-5dcc-938e-fcde49cd842f").value(), complex::FilterTraits<GBCDTriangleDumperFilter>::uuid}, // GBCDTriangleDumperFilter
    ...
    // {complex::Uuid::FromString("0a121e03-3922-5c29-962d-40d88653f4b6").value(), complex::FilterTraits<GenerateFaceIPFColoring>::uuid}, // GenerateFaceIPFColoring

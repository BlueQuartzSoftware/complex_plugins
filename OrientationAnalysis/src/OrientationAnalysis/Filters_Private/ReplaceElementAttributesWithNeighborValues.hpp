 ...
 */
class ORIENTATIONANALYSIS_EXPORT ReplaceElementAttributesWithNeighborValues : public IFilter
{
public:
  ReplaceElementAttributesWithNeighborValues() = default;
  ~ReplaceElementAttributesWithNeighborValues() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ReplaceElementAttributesWithNeighborValues, "65128c53-d3be-4a69-a559-32a48d603884");

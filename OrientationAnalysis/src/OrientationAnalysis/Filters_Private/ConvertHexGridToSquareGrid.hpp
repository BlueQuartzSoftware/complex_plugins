 ...
 */
class ORIENTATIONANALYSIS_EXPORT ConvertHexGridToSquareGrid : public IFilter
{
public:
  ConvertHexGridToSquareGrid() = default;
  ~ConvertHexGridToSquareGrid() noexcept override = default;

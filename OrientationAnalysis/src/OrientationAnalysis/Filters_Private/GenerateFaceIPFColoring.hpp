...
{
/**
 * @class GenerateFaceIPFColoring
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT GenerateFaceIPFColoring : public IFilter
{
public:
  GenerateFaceIPFColoring() = default;
  ~GenerateFaceIPFColoring() noexcept override = default;
  ...
  static inline constexpr StringLiteral k_SurfaceMeshFaceIPFColorsArrayName_Key = "surface_mesh_face_ip_fcolors_array_name";
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateFaceIPFColoring, "30759600-7c02-4650-b5ca-e7036d6b568e");

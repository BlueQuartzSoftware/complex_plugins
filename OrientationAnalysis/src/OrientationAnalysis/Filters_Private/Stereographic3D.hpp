...
{
/**
 * @class Stereographic3D
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT Stereographic3D : public IFilter
{
public:
  Stereographic3D() = default;
  ~Stereographic3D() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, Stereographic3D, "42ddcd69-dde3-4b08-b90c-6002079540eb");

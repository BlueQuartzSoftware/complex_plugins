 ...
 */
class ORIENTATIONANALYSIS_EXPORT FindBoundaryStrengths : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindBoundaryStrengths, "f39707f9-0411-4736-a591-1bfbd099bb71");

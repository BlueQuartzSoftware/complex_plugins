 ...
 */
class ORIENTATIONANALYSIS_EXPORT WriteStatsGenOdfAngleFile : public IFilter
{
public:
  WriteStatsGenOdfAngleFile() = default;
  ~WriteStatsGenOdfAngleFile() noexcept override = default;

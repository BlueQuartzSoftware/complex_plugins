 ...
 */
class ORIENTATIONANALYSIS_EXPORT FindAvgCAxes : public IFilter
{
public:
  FindAvgCAxes() = default;
  ~FindAvgCAxes() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindAvgCAxes, "453cdb58-7bbb-4576-ad5e-f75a1c54d348");

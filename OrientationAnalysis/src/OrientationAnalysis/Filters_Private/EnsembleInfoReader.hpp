 ...
 */
class ORIENTATIONANALYSIS_EXPORT EnsembleInfoReader : public IFilter
{
public:
  EnsembleInfoReader() = default;
  ~EnsembleInfoReader() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, EnsembleInfoReader, "ecf1ec45-bc27-4ddb-b2c0-3d465b8c182a");

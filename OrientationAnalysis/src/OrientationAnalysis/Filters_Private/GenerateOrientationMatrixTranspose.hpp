...
{
/**
 * @class GenerateOrientationMatrixTranspose
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT GenerateOrientationMatrixTranspose : public IFilter
{
public:
  GenerateOrientationMatrixTranspose() = default;
  ~GenerateOrientationMatrixTranspose() noexcept override = default;
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_OrientationMatrixDataArrayPath_Key = "orientation_matrix_data_array_path";
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateOrientationMatrixTranspose, "bf7cc5a9-42b6-4147-8c56-de234cd6b949");

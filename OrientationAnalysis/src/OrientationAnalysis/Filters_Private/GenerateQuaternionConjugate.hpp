...
{
/**
 * @class GenerateQuaternionConjugate
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT GenerateQuaternionConjugate : public IFilter
{
public:
  GenerateQuaternionConjugate() = default;
  ~GenerateQuaternionConjugate() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateQuaternionConjugate, "e1653c62-3894-4b95-8449-605400038110");

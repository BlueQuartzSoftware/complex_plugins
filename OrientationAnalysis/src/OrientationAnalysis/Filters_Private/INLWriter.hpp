 ...
 */
class ORIENTATIONANALYSIS_EXPORT INLWriter : public IFilter
{
public:
  INLWriter() = default;
  ~INLWriter() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, INLWriter, "a5a37eb3-c143-4b38-a89b-e0641a20dc7e");

 ...
 */
class ORIENTATIONANALYSIS_EXPORT OrientationUtility : public IFilter
{
public:
  OrientationUtility() = default;
  ~OrientationUtility() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, OrientationUtility, "cf06dcb7-fa92-4606-9716-28ede2cd1c62");

...
{
/**
 * @class GenerateFaceMisorientationColoring
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT GenerateFaceMisorientationColoring : public IFilter
{
public:
  GenerateFaceMisorientationColoring() = default;
  ~GenerateFaceMisorientationColoring() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateFaceMisorientationColoring, "f3473af9-db77-43db-bd25-60df7230ea73");

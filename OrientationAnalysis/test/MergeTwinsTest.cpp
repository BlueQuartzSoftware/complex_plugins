...
TEST_CASE("Reconstruction::MergeTwinsFilter: Instantiation and Parameter Check", "[Reconstruction][MergeTwinsFilter][.][UNIMPLEMENTED][!mayfail]")
{
  ...
  // check results
  {
    Int32Array* cellParentIdsArray = dataGraph.getDataAs<Int32Array>(k_CellParentIdsPath);
    ...
    Int32Array* featureParentIdsArray = dataGraph.getDataAs<Int32Array>(k_FeatureParentIdsPath);
    ...
    BoolArray* activeArray = dataGraph.getDataAs<BoolArray>(k_NewFeatureActivePath);

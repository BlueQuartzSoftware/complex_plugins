/**
 * This file is auto generated from the original OrientationAnalysis/ReplaceElementAttributesWithNeighborValuesFilter
 ...
 *
 * When you start working on this unit test remove "[ReplaceElementAttributesWithNeighborValuesFilter][.][UNIMPLEMENTED]"
...
TEST_CASE("OrientationAnalysis::ReplaceElementAttributesWithNeighborValuesFilter: Instantiation and Parameter Check","[OrientationAnalysis][ReplaceElementAttributesWithNeighborValuesFilter][.][UNIMPLEMENTED][!mayfail]")
{
  ...
  args.insertOrAssign(ReplaceElementAttributesWithNeighborValuesFilter::k_MinConfidence_Key, std::make_any<float32>(1.23345f));
